...
\vspace{-2mm}
{\tiny{RESUMEVERSION compiled on \today. See the latest version at \href{https://github.com/Shayennn/resume/releases/latest/download/Phitchawat_Lukkanathiti_Resume.pdf}{phitchaw.at/resume}}}\\
\vspace{2mm}
        I am a highly skilled IT Generalist who believes in automation and is interested in software engineering, computer architecture, cloud computing.
\end{center}
\vspace{2mm}
...
\textbf{LINE Pay (Thailand) Co., Ltd. \textit{\tiny{(Mobile payment and food delivery services. An entity in the LINE Group)}}} \hfill Bangkok, Thailand\\
...
\begin{outline}
	...
	\1 Experience with managing servers under PCI-DSS.
\end{outline}
\vspace{-1mm}
\textbf{Merkle Capital Co., Ltd. \textit{\tiny{(Providing digital asset management services.)}}} \hfill Bangkok, Thailand\\
\textit{Senior Full-Stack Software Engineer / Developer} \hfill Oct 2023 - Jan 2024 (4M)\\
\vspace{-1mm}
\begin{outline}
	\1 Hiring Manager (de facto, on behalf of ex-CTO), manages software engineer interview process, interviews candidates, and onboards new hires.
...
\end{itemize}
\vspace{-1mm}
\textbf{LINE MAN Wongnai Co., Ltd. \textit{\tiny{(Food delivery services. An entity in the LINE Group)}}} \hfill Bangkok, Thailand\\
