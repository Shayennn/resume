...
\begin{outline}
	\1 Develop and Maintain the Company's Main Product (Digital Asset Management Platforms)
		\2 Rapidly Responded to and Mitigated a Critical DDoS Attack (Duration: 1 hour)
		\2 Setup Background Task System with Bull and Redis
		\2 Enforce Security Policy, Fully SSL PostgreSQL Connection, etc.
		\2 Recovered from an Accidental Virtual Machines Deletion (Duration: 2 hours)
		\2 Optimized CI/CD Pipeline, Reduced Running Time from 30 minutes to 12 minutes (Reduced 18 minutes)
\end{outline}
\vspace{-1mm}
